...
export const Route = createFileRoute("/inequalities")({
  component: InequalitiesPage,
});

function InequalitiesPage() {
        ...
        <header className="border-b border-line/80">
          <div className="mx-auto max-w-xl px-4 py-10 sm:px-6">
            ...
            <ul className="mt-6 space-y-2 text-sm text-ink">
              <li>One-, two-, and three-step inequalities</li>
              <li>
                Reverse the sign when multiplying or dividing by a negative
              </li>
              <li>Graph the solution on a number line</li>
  ...
  return <StepboardApp board="inequalities" />;
}
